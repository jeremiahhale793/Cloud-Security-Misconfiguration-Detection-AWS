...
resource "aws_security_group" "open_sg" {
  ...
  # Open inbound SSH to the world (easy to detect later).
  ingress {
...
# Intentional misconfiguration:
# Disable "Block Public Access" (makes it easier for a bucket policy/ACL to expose data).
...
# -------------------------
# Outputs for reference (not strictly needed)
# -------------------------
